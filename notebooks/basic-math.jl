...
The area of a pizza is A = πr².  Lets try calculating the area of a pizza that has a radius of $r inches (**r = $6**).  Type **pi** to get the value of π and **r^2** to get the radius squared.
"""
...
let
	...
	elseif smalls_in_xl > ans + 4 * eps(ans)
		...
		correct(md"**Great!** You got it right. Let's move on.")
	end
end
