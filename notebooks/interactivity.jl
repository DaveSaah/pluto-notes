...
# ╔═╡ d30b6bf2-0054-4490-a227-1e2a8e1e36d4
using PlutoUI
...
@bind x html"<input type=range min=0 max=200>"
...
`c = ` $(@bind c html"<input type=button value='ON'>")
...
# ╔═╡ 9499609c-3567-48bc-8c14-ba2729fc63df
@bind some html"<input type=text>"

# ╔═╡ bfff2646-e889-4453-9b05-0d079d203ed7
some
...
# ╔═╡ e408222c-8cfa-4d6a-9a85-1f52e5b03391
@bind wewe Slider(5:15)

# ╔═╡ 18d9c3df-6e30-40e3-bfd3-7e07d43cfa04
wewe
