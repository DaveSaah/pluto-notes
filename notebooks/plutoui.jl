...
# ╔═╡ 62dd3955-6892-445b-bc2f-5f9e7fa5e606
print("Hello World")
...
# ╔═╡ 85916d19-780e-428b-ba9b-b231ad1e0df0
@bind money Scrubbable(30e6, format=".0s", prefix="€ ")

@bind coolness Scrubbable(0.80 : 0.01 : 1.00, format=".0%", prefix="you are 🌝 ", suffix=" cool")

# ╔═╡ 0d0b1171-54ae-4b64-b9ea-4c232df8f236
@bind money Scrubbable(30000000, format="0.00s", prefix="£ ")

# ╔═╡ c1669fb0-9192-4b24-bfeb-98aaad4ac0b2
@bind coolness Scrubbable(0.80 : 0.01 : 1.00, format=".0%", prefix="you are 🌝 ", suffix=" cool")

# ╔═╡ 3f18d894-7e19-44c2-b1a2-d9bb40c4ea23
...
# ╔═╡ 7bacc844-e8e4-494e-9fb0-9103907b7651
typeof(poem)
...
# ╔═╡ 6c3d88f5-e7f1-4f2d-9a4d-2862bdd9ade7
@bind animals MultiCheckBox(["🐰", "🐱" , "🐵", "🐘", "🦝", "🐿️" , "🐝",  "🐪"]; orientation=:column, select_all=true)

# ╔═╡ a22266cc-f321-44c9-9575-5324d82fe5f2
animals
